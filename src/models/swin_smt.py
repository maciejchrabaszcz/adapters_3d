...
from soft_moe.soft_moe_with_dynamic_slots import DynamicSlotsSoftMoE
...
class SwinSMT(nn.Module):
    ...
    def __init__(
        ...
        Args:
            ...
            use_v2: using swinsmt_v2, which adds a residual convolution block at the beggining of each swin stage.
        Examples::
        """
