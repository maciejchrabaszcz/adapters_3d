...
class PANORAMADataset(Dataset):
    ...
    def __getitem__(self, x):
        ...
        # study_ID = os.path.basename(self.labels[x])[:-7]
        # diagnosis = self.clinical_labels.loc[self.clinical_labels["PANORAMA_study_id"] == study_ID, "label"]
...
if __name__ == "__main__":
    data_path = "/Volumes/MedML/PostDoc/PANORAMA"
    lung_artery_dataset = PANORAMADataset(data_path=data_path, mode="test")
    for data in lung_artery_dataset:
        print("")